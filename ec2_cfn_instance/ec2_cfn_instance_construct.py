...
class EC2CfnInstanceConstruct(core.Construct):
    ...
    def __init__(self, scope: core.Construct, id: str,
                 ...
                 ssm_managed_iam_role: bool = False,
        ...
        :param iam_instance_profile: Existing Instance profile name for attaching to EC2 instance.
        ...
        :param disable_api_termination: If you set this parameter to true, you can't terminate the instance using the Amazon EC2 console, CLI, or API; (https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-instance.html#cfn-ec2-instance-disableapitermination)
        :instances_count: Count of instances should be created (default 1).
        :param ssm_managed_iam_role: If True, IAM role and EC2 instance profile for managing instances by SSM will be created and attached to EC2 instances (default: False).
        ...
        # Creating IAM role and EC2 instance profile
        def create_ec2_iam_role():
            ...
            return ec2_iam_role_instance_profile.instance_profile_name
        ...
        if ssm_managed_iam_role:
            assert iam_instance_profile is None, caution_message(
                'iam_instance_profile', 'ssm_managed_iam_role')
            iam_instance_profile = create_ec2_iam_role()
